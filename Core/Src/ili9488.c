...
void drawHomeScreen() {
    ...
    ILI9488_printText("1. Speed Mode", 35, yStart + 18, ILI9488_BLACK, 2);

    // Controller Mode
    fillRect(20, yStart + boxHeight + boxGap, 280, boxHeight, ILI9488_LIGHTGREY);
    ILI9488_printText("2. Controller", 35, yStart + boxHeight + boxGap + 18, ILI9488_BLACK, 2);

    // Scramble
    fillRect(20, yStart + 2 * (boxHeight + boxGap), 280, boxHeight, ILI9488_LIGHTGREY);
    ILI9488_printText("3. Scramble", 35, yStart + 2 * (boxHeight + boxGap) + 18, ILI9488_BLACK, 2);
...
// Rotate the face the motor is rotating
...
// Example function to display the Rotation
void displayRotation(uint8_t motorNumber) {
	// Clear previous stuff
	fillRect(0, 0, 320, 40, ILI9488_WHITE);
    ...
    ILI9488_printText(buffer, 10, 15, ILI9488_BLACK, 2);
}
